...
<%
            ...
            PreparedStatement st2=obj.con.prepareStatement("select * from registrationstudent where jobid in (select jobid from jobinfo where status=?)");
            st2.setString(1,"available");
            ResultSet rs2=st2.executeQuery(); 
 %>
  
 <center><h2>List Of Jobs</h2></center>
...
<table  style="width:100% ">
            ...
            <tr>
                <td>  <center>  <a href=<%= "\"AdminJobs.jsp?Id=" + rs2.getString(1) + "\"" %> %> <%= rs2.getString(1) %></a> </center>  </td>
