...
<%
 ...
 <center><h2>Click Person Name To Get More Detail</h2></center>
  ...
  <table  style="width:100% ">
            ...
            <tr>
                        <th><center> Person Applied For The Job </center></th>
            </tr>
          ...
          <% 
            ...
            <td> <center>  <a href=<%= "\"approve.jsp?Id=" + rs.getString("htid") + "\"" %> ><%= rs.getString("htid") %></a> <center> </td>
