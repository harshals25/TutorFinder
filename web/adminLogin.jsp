...
<br>
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well">
			<form role="form" action="adminLoginCode.jsp" method="post" name="form1">
				<fieldset>
					<legend>Admin Login</legend>
					
					<div class="form-group">
						<label for="name">Username</label>
						<input type="text" name="id" placeholder="Your ID" required class="form-control" />
					</div>
					...
					<div class="form-group">
						<input type="submit" name="submit" value="Submit"  onClick="check()" class="btn btn-primary" />
					</div>
				</fieldset>
			</form>
			  <%
