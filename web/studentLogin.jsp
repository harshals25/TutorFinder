...
<%    
    ...
    PreparedStatement st=obj.con.prepareStatement("select htid from allotted where jobid=?");
    st.setString(1,id);
...
%>
            ...
            name: <%= rs2.getString(2)%><br>
            mobile no: <%= rs2.getString(4)%><br>
