...
<%
    ...
    PreparedStatement st=obj.con.prepareStatement("select jobid from registrationstudent");
    ...
    jobid=jobid+1;
    String jobid1 = Integer.toString(jobid);
    PreparedStatement st1=obj.con.prepareStatement("insert into registrationstudent values (?,?,?,?,?,?,?,?,?)");
    st1.setString(2,area);
    st1.setString(3,name);
    st1.setString(4,mobile);
    st1.setString(5,tfc);
    st1.setString(6,subjects);
    st1.setString(7,address);
    st1.setString(8,comments);
    st1.setString(9,email);
    st1.setString(1,jobid1);
    st1.executeUpdate();
    
    PreparedStatement st2=obj.con.prepareStatement("insert into jobinfo values (?,?)");    
    st2.setString(1,jobid1);
    ...
    //response.sendRedirect("jobRegister.html");
%>
 <div style="border:1px solid black; border-radius: 25px;">
<center>
     <form action="jobRegister.html">
       <p>You have registered Successfully.</p>
       <p>Your job id is <%=jobid1%></p>
       <p>Please note your jobid for future reference </p>
